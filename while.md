...
within the body of the loop, which is why we put the special `print` function
at the end.
...
trace and understand small fragments of Python code.  The one we recommend is
at  http://netserv.ict.ru.ac.za/python3_viz
